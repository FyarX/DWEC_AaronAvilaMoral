...
})({"f2Dbk":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "40b24c8cf585e795";
"use strict";
...
},{}],"jAnSP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery"); // No olvidar añadir type="module" en el json de la página
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
//* Asi se comienza un fichero en JQuery
(0, _jqueryDefault.default)(()=>{
    // Seleccionar elementos por su clase
    (0, _jqueryDefault.default)('.parrafo');
    // Seleccionar todos los p y section
    (0, _jqueryDefault.default)("p"), (0, _jqueryDefault.default)("section");
    // Selecciona el último p
    (0, _jqueryDefault.default)("p:last-of-type");
    //? Eventos 
    (0, _jqueryDefault.default)("#button1").on("click", ()=>{
        alert("Has pulsado el bot\xf3n 1");
    });
    /*
    ...
    */ //? Modificar atributos y propiedades
    (0, _jqueryDefault.default)("p.parrafo").on("mouseover", ()=>{
        (0, _jqueryDefault.default)("p.parrafo").text("Has pasado por encima de este p\xe1rrafo");
    });
    (0, _jqueryDefault.default)("p.parrafo").on("mouseout", ()=>{
        (0, _jqueryDefault.default)("p.parrafo").attr("href", "P\xe1rrafo de ejemplo");
    });
    (0, _jqueryDefault.default)("#button3").on("click", ()=>{
        (0, _jqueryDefault.default)("img").attr("alt", "Tu prima");
        (0, _jqueryDefault.default)("p");
    });
    /*
    attr(), prop(), removeAttr(), removeProp(), val(), text(), html(), css(), addClass(), removeClass(), toggleClass(),
    */ //? Modificar el DOM
    // Añadir un elemento
    (0, _jqueryDefault.default)("#button4").on("click", ()=>{
        (0, _jqueryDefault.default)("section").append("<p>Este es un nuevo p\xe1rrafo</p>");
        (0, _jqueryDefault.default)("section").prepend("<p>Este es un nuevo p\xe1rrafo al final</p>");
    });
    // Envolver un elemento
    (0, _jqueryDefault.default)("section").wrap("<div></div>");
    // Desenvolver un elemento
    (0, _jqueryDefault.default)("section").unwrap();
    // Eliminar un elemento
    (0, _jqueryDefault.default)("section").remove();
});
...
},{}]},["f2Dbk","jAnSP"], "jAnSP", "parcelRequire94c2")

//# sourceMappingURL=index.f585e795.js.map
